...
# ===============================
# BACKGROUND + GLASS + BUTTON + ICON STYLES
# ===============================
def add_bg_and_styles(image_file):
    ...
    st.markdown(f"""
        ...
        .block-container h1, .block-container h2,
        .block-container h3, .block-container h4, .block-container p,
        .block-container label, .block-container span, .block-container div {{
            color: black !important;
        }}
        ...
        /* Hover effect for Register & Attendance Buttons */
        div[data-testid="stButton"] > button:hover {{
        ...
        /* DataFrame & Chart Toolbar Icons White */
        button[title="Search"],
        button[title="Download CSV"],
        button[title="Fullscreen"],
        button[title="Show chart/table"],
        button[title="Sort"] {{
            color: white !important;
            fill: white !important;
        }}

        div.stToolbar, div[role="toolbar"] {{
            background-color: rgba(0,0,0,0.3) !important;
        }}
        </style>
    """, unsafe_allow_html=True)

add_bg_and_styles("background.jpg")
